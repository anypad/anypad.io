export const upcomingProjects = [
  ...
  },
  {
    title: "Animalia",
    description:
      "Animalia is an independent free-to-play online Nft trading card game featuring crypto-inspired meme creatures and gemstones. Powered by the BNB Chain",
    targetRaise: "50k",
    tokenPrice: "TBA",
    idoDate: "TBA",
  ...
  //   title: "Stman",
  //   description:
  //     "Revolutionary of P2E Game. Say 'No' with inflation, just enjoy a free-to-play-and-earn mechanism with StickMan game crypto",
  //   targetRaise: "50k",
  //   tokenPrice: "TBA",
  //   idoDate: "TBA",
